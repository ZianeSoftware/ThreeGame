...
bkcore.hexgl.tracks.Cityscape = {
        ...
        if (quality < 1) // LOW
        {
            this.lib.load({
                textures: {
                    ...
                    'car.feisar.diffuse': "geometries/ships/feisar/sin_car_exterior01a.jpg",
                ...
                geometries: {
                    ...
                    'ship.feisar': "geometries/ships/feisar/car.js",
    ...
    buildMaterials: function (quality) {
        if (this.quality < 1) // LOW
        {
            ...
            this.materials.ship = new THREE.MeshBasicMaterial({
                ...
                map: this.lib.get("geometries", "car.feisar.diffuse"),
                ambient: 0xaaaaaa
            });
    ...
    buildScenes: function (ctx, quality, lvlTime) {
        // IMPORTANT
        ...
        var materials = new THREE.MeshLambertMaterial({
            //color: 0xff6600,
            diffuse: this.lib.get("geometries", "car.feisar.diffuse")
        ...
        //m.materials = new Array();
        //m.materials[0] =  this.materials.ship; // car body


        var m = new THREE.MeshFaceMaterial();
        m.materials = new Array();

        m.materials[0] = new THREE.MeshBasicMaterial({
            //map: this.lib.get("textures", "ship.feisar.diffuse"),
            map: this.lib.get("geometries", "car.feisar.diffuse"),
            ambient: 0xaaaaaa
        });

        m.materials[1] = this.materials.ship; // wheels chrome
        m.materials[2] = this.materials.ship; // grille chrome
        m.materials[3] = this.materials.ship; // door lines
        m.materials[4] = this.materials.ship; // windshield
        m.materials[5] = this.materials.ship; // interior
        m.materials[6] = this.materials.ship; // tire
        m.materials[7] = this.materials.ship; // tireling
        m.materials[8] = this.materials.ship; // behind grille
        m.materials[9] = this.materials.ship; // tireling
        m.materials[10] = this.materials.ship; // behind grille
        m.materials[11] = this.materials.ship; // behind grille
        ...
        var ship = ctx.createMesh(scene, this.lib.get("geometries", "ship.feisar"), -1134 * 2, 10, -443 * 2, m);
        //var ship = createScene(this.lib.get("geometries", "ship.feisar"), this.materials.ship);
        ...
        shipControls.levelTime = lvlTime;
        ...
        ctx.manager.add("game", scene, camera, function (delta, renderer) {
            ...
            this.objects.hud.update(
                ...
                this.objects.components.shipControls.getMiddleTotalTime()
			);
