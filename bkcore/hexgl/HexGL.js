...
bkcore.hexgl.HexGL = function(opts)
{
    ...
    this.levelTime = opts.levelTime == undefined ? 90 : opts.levelTime;
	this.quality = opts.quality == undefined ? 0 :0;// opts.quality;
...
bkcore.hexgl.HexGL.prototype.init = function()
{
	...
	this.track.buildScenes(this, this.quality,this.levelTime);
